...
<img src="figures/plot3.png" width="750" height="600">

Looking at the number of terrorist attacks by region and by country, it is evident that Middle Eastern countries and South Asian countries have a much higher attacked rate, which is supported by the data from the table. This may be due to the fact that many countries in these areas have unstable political regimes and have several groups fighting for control of the government. It may also be interesting to note that 
