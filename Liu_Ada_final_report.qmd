...
In order to answer this question, it is important to define what severity means. For this analysis, severity will be defined as the rate of success, the number of people killed and wounded by an attack, and if there was property damage.
